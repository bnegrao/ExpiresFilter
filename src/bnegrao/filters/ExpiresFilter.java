...
import bnegrao.filters.FilterBase;
...
public class ExpiresFilter extends FilterBase {
    ...
    public class XHttpServletResponse extends HttpServletResponseWrapper {
        ...
        /**
         * Stores the httpStatus code (for servlet apis before 3.0)
         */
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
		...
		Enumeration<String> names = filterConfig.getInitParameterNames(); names.hasMoreElements();) {
